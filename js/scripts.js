...
$(document).ready(function(){
	...
	var typed = new Typed(".typed", {
		strings: ["Coming Soon.", "Just Stay Tuned......"],
		typeSpeed: 70,
		loop: true,
		startDelay: 1000,
		showCursor: false,
	...
	$(window).scroll(function() {
		...
		if (!countUpFinsished && window.pageYOffset > statsTopOffset - $(window).height() + 200) {
